...
void MainWindow::playedDurationChanged(unsigned long long newAudioDuration) {
    QTime time(0, 0, 0, 0);
...
void MainWindow::on_pushButton_clicked()
{
    ...
    if (_isAudioPlaying == false) { // 点击了“开始播放”
        ...
        connect(_audioPlayThread, &AudioPlayThread::playedAudioDurationChangned,
                this, &MainWindow::playedDurationChanged);
